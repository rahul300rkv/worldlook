...
export const LAYER_REGISTRY: Record<keyof MapLayers, LayerDefinition> = {
  ...
  startupHubs:              def('startupHubs',              '&#128640;', 'startupHubs',              'Startup Hubs', ['flat']),
  techHQs:                  def('techHQs',                  '&#127970;', 'techHQs',                  'Tech HQs', ['flat']),
  accelerators:             def('accelerators',             '&#9889;',   'accelerators',             'Accelerators', ['flat']),
  cloudRegions:             def('cloudRegions',             '&#9729;',   'cloudRegions',             'Cloud Regions', ['flat']),
  techEvents:               def('techEvents',               '&#128197;', 'techEvents',               'Tech Events'),
  stockExchanges:           def('stockExchanges',           '&#127963;', 'stockExchanges',           'Stock Exchanges', ['flat']),
  financialCenters:         def('financialCenters',         '&#128176;', 'financialCenters',         'Financial Centers', ['flat']),
  centralBanks:             def('centralBanks',             '&#127974;', 'centralBanks',             'Central Banks', ['flat']),
  commodityHubs:            def('commodityHubs',            '&#128230;', 'commodityHubs',            'Commodity Hubs', ['flat']),
  gulfInvestments:          def('gulfInvestments',          '&#127760;', 'gulfInvestments',          'GCC Investments', ['flat'], undefined, true),
  positiveEvents:           def('positiveEvents',           '&#127775;', 'positiveEvents',           'Positive Events', ['flat'], undefined, true),
  kindness:                 def('kindness',                 '&#128154;', 'kindness',                 'Acts of Kindness', ['flat'], undefined, true),
  happiness:                def('happiness',                '&#128522;', 'happiness',                'World Happiness', ['flat'], undefined, true),
  speciesRecovery:          def('speciesRecovery',          '&#128062;', 'speciesRecovery',          'Species Recovery', ['flat'], undefined, true),
  renewableInstallations:   def('renewableInstallations',   '&#9889;',   'renewableInstallations',   'Clean Energy', ['flat'], undefined, true),
  miningSites:              def('miningSites',              '&#128301;', 'miningSites',              'Mining Sites', ['flat'], undefined, true),
  processingPlants:         def('processingPlants',         '&#127981;', 'processingPlants',         'Processing Plants', ['flat'], undefined, true),
  commodityPorts:           def('commodityPorts',           '&#9973;',   'commodityPorts',           'Commodity Ports', ['flat'], undefined, true),
