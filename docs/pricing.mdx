...
- **Free** — 57 map layers (all free except Resilience, which is Pro), 500+ curated feeds backed by 549+ observed upstream hosts, country briefs, hotspots, instability scores, chokepoints, cascade analysis, breaking alerts, and watchlists, across 3 dashboard tabs. Dashboard refresh cadence is typically 5–15 minutes.
